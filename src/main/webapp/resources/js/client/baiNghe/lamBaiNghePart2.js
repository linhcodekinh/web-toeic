			...
			success: function(result){
				...
				$.each(result.content, function(i, cauHoi){
					var divCauHoi = '<div class="postmetadata">'
						+ '<ul><li style="font-weight: bold"><i class="icon-user"></i>Câu '+ cauHoi.soThuTu +'</li></ul></div>'
...
//				soCau = result.totalElements;
				$.each(result.content, function(i, cauHoi){
					...
					var divGiaiThich = '<div class="postmetadata"><ul><li style="font-weight: bold"><i class="icon-user"></i>Câu '+ stt ;
